...
export default function Footer() {
  const { up } = useContext(myContext);

  return (
    <footer className='footer'>
      <div className='footer-group1'>
        <img className='footer-mobil-img' src={logo} alt='' />
        {/* <img className='tablet-img' src={logotablet} alt='' /> */}
        <nav className='nav-links'>
          <Link to='/' onClick={up}>
            HOME
          </Link>
          <Link to='/about' onClick={up}>
            ABOUT US
          </Link>
          <Link to='/subscribe' onClick={up}>
            Create your plan
          </Link>
        </nav>
      </div>
